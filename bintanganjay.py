...
kr = Aan.LINE()
#kr.login(qr=True)
kr.login(token='EqLfm45jXSmfGRp58Vp1.6UxFsmztgQddxTQLfoSSmq.KiDucovlSPOMUpHM4X6jLueCy6gxZgOw5WdPkSZl57U')#aanjutawan
kr.loginResult()
...
╔═════[ Template List ]
╠[1] tenguy = 10 Guy
╠[2] afraid = Afraid to Ask Andy
╠[3] older = An Older Code Sir, But It Checks Out
╠[4] aag = Ancient Aliens Guy
╠[5] tried = At Least You Tried
╠[6] biw = Baby Insanity Wolf
╠[7] stew = Baby, You've Got a Stew Going
╠[8] blb = Bad Luck Brian
╠[9] kermit = But That's None of My Business
╠[10] bd = Butthurt Dweller
╠[11] ch = Captain Hindsight
╠[12] cbg = Comic Book Guy
╠[13] wonka = Condescending Wonka
╠[14] cb = Confession Bear
╠[15] keanu = Conspiracy Keanu
╠[16] dsm = Dating Site Murderer
╠[17] live = Do It Live!
╠[18] ants = Do You Want Ants?
╠[19] doge = Doge
╠[20] drake = Drakeposting
╠[21] ermg = Ermahgerd
╠[22] facepalm = Facepalm
╠[23] firsttry = First Try!
╠[24] fwp = First World Problems
╠[25] fa = Forever Alone
╠[26] fbf = Foul Bachelor Frog
╠[27] fmr = Fuck Me, Right?
╠[28] fry = Futurama Fry
╠[29] ggg = Good Guy Greg
╠[30] hipster = Hipster Barista
╠[31] icanhas = I Can Has Cheezburger?
╠[32] crazypills = I Feel Like I'm Taking Crazy Pills
╠[33] mw = I Guarantee It
╠[34] noidea = I Have No Idea What I'm Doing
╠[35] regret = I Immediately Regret This Decision!
╠[36] boat = I Should Buy a Boat Cat
╠[37] hagrid = I Should Not Have Said That
╠[38] sohappy = I Would Be So Happy
╠[39] captain = I am the Captain Now
╠[40] bender = I'm Going to Build My Own Theme Park
╠[41] inigo = Inigo Montoya
╠[42] iw iw = Insanity Wolf
╠[43] ackbar = It's A Trap!
╠[44] happening = It's Happening
╠[45] joker joker = It's Simple, Kill the Batman
╠[46] ive = Jony Ive Redesigns Things
╠[47] ll = Laughing Lizard
╠[48] away = Life... Finds a Way
╚═════════════════
"""
memelist2 ="""
╔═════[ Template List ]
╠[50] mb = Member Berries
╠[51] badchoice = Milk Was a Bad Choice
╠[52] mmm = Minor Mistake Marvin
╠[53] jetpack = Nothing To Do Here
╠[54] imsorry = Oh, I'm Sorry, I Thought This Was America
╠[55] red = Oh, Is That What We're Going to Do Today?
╠[56] mordor = One Does Not Simply Walk into Mordor
╠[57] oprah = Oprah You Get a Car
╠[58] oag = Overly Attached Girlfriend
╠[59] remembers = Pepperidge Farm Remembers
╠[60] philosoraptor = Philosoraptor
╠[61] jw = Probably Not a Good Idea
╠[62] patrick = Push it somewhere else Patrick
╠[63] rollsafe = Roll Safe
╠[64] sad-obama = Sad Barack Obama
╠[65] sad-clinton = Sad Bill Clinton
╠[66] sadfrog = Sad Frog / Feels Bad Man
╠[67] sad-bush = Sad George Bush
╠[68] sad-biden = Sad Joe Biden
╠[69] sad-boehner = Sad John Boehner
╠[70] saltbae = Salt Bae
╠[71] sarcasticbear = Sarcastic Bear
╠[72] dwight = Schrute Facts
╠[73] sb = Scumbag Brain
╠[74] ss = Scumbag Steve
╠[75] sf = Sealed Fate
╠[76] dodgson = See? Nobody Cares
╠[77] money = Shut Up and Take My Money!
╠[78] snek = Skeptical Snake
╠[79] sk = Skeptical Third World Kid
╠[80] sohot = So Hot Right Now
╠[81] nice = So I Got That Going For Me, Which is Nice
╠[82] awesome-awkward = Socially Awesome Awkward Penguin
╠[83] awesome = Socially Awesome Penguin
╠84] awkward-awesome = Socially Awkward Awesome Penguin
╠[85] awkward = Socially Awkward Penguin
╠[86] fetch = Stop Trying to Make Fetch Happen
╠[87] success = Success Kid
╠[88] scc = Sudden Clarity Clarence
╠[89] ski = Super Cool Ski Instructor
╠[90] officespace = That Would Be Great
╠[91] interesting = The Most Interesting Man in the World
╠[92] toohigh = The Rent Is Too Damn High
╠[93] bs = This is Bull, Shark
╠[94] fine = This is Fine
╠[95] sparta = This is Sparta!
╠[96] whatyear = What Year Is It?
╠[97] center = What is this, a Center for Ants?!
╠[98] both = Why Not Both?
╠[99] winter = Winter is coming
╠[100] xy = X all the Y
╠[101] buzz = X, X Everywhere
╠[102] yodawg = Xzibit Yo Dawg
╠[103] yuno = Y U NO Guy
╠[104] yallgot = You all Got Any More of Them
╠[105] bad = You Should Feel Bad
╠[106] elf = You Sit on a Throne of Lies
╠[107] chosen = You Were the Chosen One!
╚═════════════════
"""
helpsosial ="""
╠════════════════════
...
Bots=[mid]
owner=["ueae5df48c6531aa0c35edaa514eb2c31",mid]
admin=["ueae5df48c6531aa0c35edaa514eb2c31",mid]
baby=["ueae5df48c6531aa0c35edaa514eb2c31"]
        ...
        if op.type == 26:
            ...
            if "MENTION" in msg.contentMetadata.keys() != None:
                 if wait['detectMention'] == True:
                     ...
                     msg.text1 = "@"+cName+" "
                     balas = ["nanti saja ya teman, sekarang lagi off"]
            ...
            if msg.contentType == 13:
                if wait["gift"] == True:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                kr.sendText(msg.to,"Gift Sudah Terkirim!")
                                msg.contentType = 9
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
              ...
              if msg.from_ in admin:
                ...
                if wait["lang"] == "JP":
                    kr.sendText(msg.to,helpsosial)
                else:
                    kr.sendText(msg.to,helpsosial)
            elif msg.text.lower() == 'translate':
                if wait["lang"] == "JP":
                    kr.sendText(msg.to,helptrans)
                else:
                    kr.sendText(msg.to,helptrans)
            elif msg.text.lower() == 'member':
                if wait["lang"] == "JP":
                    kr.sendText(msg.to,helpmem)
                else:
                    kr.sendText(msg.to,helpmem)
                ...
                if wait["lang"] == "JP":
                    kr.sendText(msg.to,helpsteal)
                else:
                    kr.sendText(msg.to,helpsteal)
            elif msg.text.lower() == 'group':
                if wait["lang"] == "JP":
                    kr.sendText(msg.to,helpgroup)
                else:
                    kr.sendText(msg.to,helpgroup)
            
            elif msg.text.lower() == 'meme':
                if wait["lang"] == "JP":
                    kr.sendText(msg.to,memelist)
                else:
                    kr.sendText(msg.to,memelist)
                    
            elif msg.text.lower() == 'meme2':
                if wait["lang"] == "JP":
                    kr.sendText(msg.to,memelist2)
                else:
                    kr.sendText(msg.to,memelist2)    
            
            
            elif msg.text.lower() == 'spesial':
                if wait["lang"] == "JP":
                    kr.sendText(msg.to,helpspec)
                else:
                    kr.sendText(msg.to,helpspec)
                    
            elif msg.text.lower() == 'help':
                if wait["lang"] == "JP":
                    kr.sendText(msg.to,helpkey)
                else:
                    kr.sendText(msg.to,helpkey)
                ...
                kr.sendMessage(msg)
                    ...
                    kr.sendMessage(msg)
                    xname = kr.getProfile().displayName
            ...
            elif msg.text in ["Weather"]:
                print("Command cuacasearch")
                baseurl = "https://query.yahooapis.com/v1/public/yql?"
                yql_query = "select * from weather.forecast where woeid in (select woeid from geo.places(1) where text=\""+text+"\") and u=\"c\""
                yql_url = baseurl + urllib.parse.urlencode({'q':yql_query}) + "&format=json"
                result = urllib.request.urlopen(yql_url).read()
                data = json.loads(result.decode())
                city = "╠[★]Negara: " + data['query']['results']['channel']['location']['country']
                city1 = "\n╠[★]Kota: " + data['query']['results']['channel']['location']['city']
                city2 = "\n╠[★]Wilayah: " + data['query']['results']['channel']['location']['region']
                temp = "\n╠[★]Status: " + data['query']['results']['channel']['item']['condition']['temp']
                tempU = data['query']['results']['channel']['units']['temperature']
                if(tempU=="C"):
                   tempU="°"
                else:
                    pass
                cuaca = " " + data['query']['results']['channel']['item']['condition']['text']
                kr.sendText(to,"╔════[ Info ]═════\n"+city+ city1 + city2 + temp + tempU + cuaca+"\n╚═══════════════")
                ...
                kr.sendMessage(msg)
                       ...
                       if targets == []:
                           ...
                           for target in targets:
                                try:
                                    kr.sendText(msg.to,_name + " Check Your Gift")
                                    msg.contentType = 9
                                    msg.contentMetadata= {'PRDTYPE': 'STICKER',
                                                         'STKVER': '1',
                                                         'MSGTPL': '1',
...
#==================================================================================================#
                ...
                if msg.toType == 2:
                   ...
                   kr.sendImageWithURL(msg.to,memes)
            
            elif "Ytlink " in msg.text:
                try:
                    ...
                    kr.sendText(msg.to,'https://www.youtube.com' + results['href'])
                except:
                    ...
                    try:
                        ...
                        soup = BeautifulSoup(html, "html.parser")
                        results = soup.find(attrs={'class': 'yt-uix-tile-link'})
                        kr.sendVideoWithURL(msg.to,'https://www.youtube.com' + results['href'])
                    except:
                        kr.sendText(msg.to, "Could not find it")                    
...
#==================== RESPON========================
                ...
                if wait['Wc'] == True: md+="╠❂➣Sambut:on [✅]\n"
                else: md +="╠❂➣Sambut:off [❌]\n"
                if wait['Lv'] == True: md+="╠❂➣Pergi:on [✅]\n"
                else: md +="╠❂➣Pergi:off [❌]\n"
...
#==============================================================================#
              ...
              if msg.from_ in owner:
                kr.sendText(msg.to,"السَّلاَمُ عَلَي��������كُمْ وَرَحْمَةُ اللهِ وَبَرَكَاتُهُ")
                kr.sendText(msg.to,"Assalamu'alaikum")
...
#====================API KEY FUNTION===================================================================================            
              ...
              if msg.from_ in admin:
                            ...
                            with requests.session() as web:
                                web.headers["user-agent"] = "Mozilla/5.0 (X11; Linux i686) AppleWebKit/537.17 (KHTML, like Gecko) Chrome/24.0.1312.27 Safari/537.17"
                ...
                kr.sendImageWithURL(msg.to, urlnya)
#=======================================================================================================
            elif ".gt " in msg.text:
...
#=======================================================================================================
               ...
               if msg.from_ in admin:
                ...
                x+="☸️ Bᴏᴛ Cʀᴇᴀᴛᴏʀ: S T A R new B O T\n"
                x+="☸️ Bᴏᴛ Oᴡɴᴇʀ: "+kr.getProfile().displayName+"\n"
                x+="☸️ Bᴏᴛ Tʏᴘᴇ: Sᴇʟғʙᴏᴛ\n"
                x+="☸️ Vᴇʀsɪᴏɴ: 7.0\n"
                x+="╠════════════════\n"
                x+="「Cᴏɴᴛᴀᴄᴛ Pᴇʀsᴏɴᴀʟ」\n"
                x+="「 ▶️ ID LINE: line://ti/p/~bintanga2 」\n\n"
                x+="S T A R new B O T"
                kr.sendText(msg.to,x)
                msg.contentType = 13
                msg.contentMetadata = {'mid': mid}
                kr.sendMessage(msg)
                 ...
                 if False:
                 	kr.sendText(msg.to,"Gaada ID kayak gitu anjeng!")
                 if True:
                     msg.contentType = 13
                     msg.contentMetadata = {'mid': conn.mid}
                     kr.sendText(msg.to,"[ Nama Profil ]\n"+conn.displayName+"\n\n[ Status Profil ]\n"+conn.statusMessage+"\n\n[ Mid Profil ]\n"+conn.mid+"\n\n[ URL Foto Profil ]\nhttp://dl.profile.line-cdn.net/"+conn.pictureStatus+"\n\nKepoin lebih lanjut?\nKlik line://ti/p/~"+msgg)
                     kr.sendMessage(msg)
...
#===================================================================================================
                     ...
                     data = response.json()
                     pictweb = data['result']
                     kr.sendImageWithURL(msg.to,pictweb)
#=================================================================
            if "Info saya" in msg.text:
              ...
              kr.sendText(msg.to,"• Nama : "+kr.getContact(msg.from_).displayName+"\n• Kelamin : "+k+"\n• Wajah : "+w+"\n• Status Kehidupan : "+s)
#============================================================================
            elif ".is " in msg.text:
                ...
                data = response.json()
                pictig = data['result']
                kr.sendImageWithURL(msg.to,pictig)
#=====================================================================================================
            elif "kedipkan" in msg.text.lower():
                txt = msg.text.replace("kedapkedip ","")
                t1 = "\xf4\x80\xb0\x82\xf4\x80\xb0\x82\xf4\x80\xb0\x82\xf4\x80\xb0\x82\xf4\x80\xa0\x81\xf4\x80\xa0\x81\xf4\x80\xa0\x81"
                t2 = "\xf4\x80\x82\xb3\xf4\x8f\xbf\xbf"
                kr.sendText(msg.to, t1 + txt + t2)
#====================================================================================================
            elif msg.text in ["Myt"]:
              if msg.from_ in admin:
                kr.sendText(msg.to,kr.authToken)
...
#==========================================================================================================================
                ...
                if msg.toType == 2:
                    ...
                    group = kr.getGroup(msg.to)
                    tanggal = time.strftime("%a,%d %b %Y %H:%M", time.localtime(int(group.createdTime)/1000))
                    try:
...
#==============================================================================#
                ...
                try:
                    ...
                    kr.sendImageWithURL(msg.to, nadya)
            ...
            elif "profileig" in msg.text.lower():
                    sep = msg.text.split(" ")
                    search = msg.text.replace(sep[0] + " ","")
                    with requests.session() as web:
                        web.headers["User-Agent"] = "Mozilla/5.0 (X11; Linux i686) AppleWebKit/537.17 (KHTML, like Gecko) Chrome/24.0.1312.27 Safari/537.17"
                        ...
                        try:
                            ...
                            kr.sendText(msg.to, "Pengguna tidak ditemukan")
                ...
                contact = kr.findContactsByUserid(userid)
                msg.contentType = 13
...
#==============================================================================#
                ...
                van = "Bot Bintang telah aktif selama "+waktu(eltime)
...
#================================ KRIS SCRIPT STARTED ==============================================#
                    ...
                    kr.sendText(msg.to, "https://www.google.co.id/search?q=" + b)
       ...
       # if op.type == 5:
        ...
        if op.type == 17:
           if wait["Wc"] == True:
               ...
               cinfo = kr.getContact(op.param2)
               kr.sendText(op.param1, "╔═════════════\n║Selamat Datang Di  " + str(ginfo.name) + "\n╠═════════════\n" + "║Founder =>>> " + str(ginfo.name) + " :\n║" + ginfo.creator.displayName + "\n╠═════════════\n" + "║😊Semoga Betah Kak 😘 \n╚═════════════")
               kr.sendImageWithURL(op.param1,"http://dl.profile.line-cdn.net/"+str(cinfo.pictureStatus))
                        ...
                        if op.param1 in cctv['point']:
                            ...
                            if Name in cctv['sidermem'][op.param1]:
                                ...
                                if " " in Name:
                                    nick = Name.split(' ')
                                    if len(nick) == 2:
                                        kr.sendText(op.param1, "Jangan Jadi sider lu, gabung dong " +nick[0])
                                        summon(op.param1,[op.param2])
